...
def printfreeman(freemantype_):
    for _ in tqdm(range(100), desc="Generating Freeman"):
        sleep(0.01)

    # Print Freeman ASCII art
    print(Fore.YELLOW + freemanart[freemantype_])
